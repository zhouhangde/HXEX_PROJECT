  ...
  <div class="account-box wrap fColor1 bg-part clr-part">
      ...
      <div class="ptb10 w50 margin">
        ...
        <div class="flex alcenter hand_box mt20">
          ...
          <div class="ml10">
            ...
            >请提供一张您手持证件照的照片，在同张照片中也要包含有“HXEX”、日期和您的签名的注释。请确保您的脸部清晰可见，且所有证件详细信息都清楚可读</p>
            <div class="flex">
              <div>
                ...
                <p class="ft12 flex alcenter s_ico">
                  <img src="../assets/images/success.png">带有[HXEX]的文字注释
                </p>
              </div>
    ...
    <div v-if="lever == 9">
      ...
      <div class="ptb10 w50 margin">
        ...
        <p class="mb10 ft12">
          请提供一张您本人的HXEX账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息
          清晰可读。
        </p>
        <el-upload
