...
<!--			市场-->
			<div class="main-l fl flex" style="width:300px;">
				<div class="sidebar  part-bg" style="width:300px;margin-left:6px;margin-right: 6px">
					<market></market>
				</div>
			</div>
<!--			tv和实时成交的k线图-->
			<div class="main-m flex " style="width:84%;overflow: hidden;">
				<div class="chart_wrap flex column bgWhite part-bg" style="width:81%;margin-right:6px;">
					<!-- <chart></chart> -->
